...
- [ ] **PAR-03**: A managed Bot reproduces required weapon selection, aiming, firing, reload, ammunition, and damage/death behavior. Phase 7 offline intent/feedback contracts are complete; Windows x86 now has partial live human-damage/death evidence, while autonomous combat, weapon/reload/ammunition behavior, respawn, and cross-platform parity remain pending Phase 8.
