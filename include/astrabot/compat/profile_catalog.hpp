...
namespace astrabot
{
	namespace compat
	{
		...
		{
		  public:
			static constexpr std::size_t kMaximumProfiles = 256U;
			...
			ProfileSelectionResult select(ProfileTeam team, int difficulty,
										  std::size_t selectionIndex, ProfileRecord *profile) const;
			ProfileSelectionResult selectNamed(const char *name, ProfileTeam team,
