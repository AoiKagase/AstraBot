...
struct Fixture
{
	...
	Fixture()
	{
		...
		const p::Stamp stamp{kAgent, kBot, input.map, input.tick, input.timeMicros, input.round};
		visual.stamp = stamp;
		visual.count = 1;
		...
		visual.memories[0].identity = {input.map, input.round,		p::ObservationSource::Vision,
									   1,		  input.timeMicros, input.timeMicros};
		sounds.stamp = stamp;
...
void assertSuppressed(const c::FireAuthorization& result, c::CombatReason reason)
{
	assert(result.decision.action != c::CombatAction::Fire);
	assert(!result.decision.fireMode.has_value());
	assert(!result.decision.firePlan.has_value());
...
void testVisibilityAndRelationGates()
{
	{
		Fixture fixture;
		fixture.visual.memories[0].identity.source = p::ObservationSource::TeamReport;
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::InvalidVisibility);
	}
	{
		Fixture fixture;
	...
	}
	{
		...
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::UnknownRelation);
	}
	{
		Fixture fixture;
		fixture.input.world.roster[kTarget.slot - 1U] = {kTarget, p::Team::CounterTerrorist};
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::Ally);
	}
}
...
{
	{
		...
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::ReactionDelay);
	}
	{
		Fixture fixture;
		fixture.input.weapon.reloading = true;
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::Reloading);
	}
	{
		Fixture fixture;
		fixture.input.weapon.clipAmmo = 0;
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::EmptyClip);
	}
	{
		Fixture fixture;
		fixture.input.weapon.primaryAttackReadyMicros = fixture.input.timeMicros + 1;
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::Cooldown);
	}
}
...
{
	{
		...
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::StaleInput);
	}
	{
		Fixture fixture;
	...
	}
	{
		...
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::StaleWeapon);
	}
	{
		Fixture fixture;
		fixture.input.weapon.active = {};
		assertSuppressed(c::authorizeFire(fixture.input, fixture.aim, {}), c::CombatReason::InvalidWeapon);
	}
	{
		Fixture fixture;
...
void testLifecycleAndGenerationReset()
{
	...
	const auto duplicate = c::authorizeFire(fixture.input, fixture.aim, first.nextState);
	...
	const p::Stamp stamp{
		kAgent, kBot, fixture.input.map, fixture.input.tick, fixture.input.timeMicros, fixture.input.round};
