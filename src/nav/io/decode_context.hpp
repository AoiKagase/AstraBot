...
struct DecodeContext final
{
	...
	diagnostics::NavError charge(std::size_t count, std::size_t width, diagnostics::NavError at) noexcept;
	diagnostics::NavError observe(std::size_t offset, diagnostics::NavRecord record, diagnostics::NavField field,
