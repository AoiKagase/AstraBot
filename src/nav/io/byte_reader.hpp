...
public:
	...
	ReadResult<std::uint8_t> readU8(NavRecord record = NavRecord::RawInput,
									NavField field = NavField::RawBytes) noexcept;
	ReadResult<std::uint16_t> readU16LE(NavRecord record = NavRecord::RawInput,
										NavField field = NavField::RawBytes) noexcept;
	ReadResult<std::uint32_t> readU32LE(NavRecord record = NavRecord::RawInput,
										NavField field = NavField::RawBytes) noexcept;
	ReadResult<float> readF32LE(NavRecord record = NavRecord::RawInput, NavField field = NavField::RawBytes) noexcept;
	ReadResult<ByteView> readBytes(std::size_t length, NavRecord record = NavRecord::RawInput,
								   NavField field = NavField::RawBytes) noexcept;
...
private:
	...
	ReadResult<ByteView> availableBytes(std::size_t length, NavRecord record, NavField field) const noexcept;
