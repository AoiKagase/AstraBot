...
public:
	...
	build(std::shared_ptr<const model::NavMeshSnapshot> snapshot, const NavSpatialIndexLimits& limits) noexcept;
...
private:
	...
	NavQueryResult query(model::NavVector3 point, NavQueryLimits limits, bool containment) const noexcept;
};
} // namespace astrabot::nav::query
