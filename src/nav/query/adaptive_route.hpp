...
struct AdaptiveTraversalExperience final
{
	...
	bool eligible(std::uint32_t minimumHumanAttempts, double minimumHumanSuccessRate) const noexcept;
};
...
struct AdaptiveRouteSettings final
{
	...
	core::learning::ApproachDirection approachDirection{core::learning::ApproachDirection::Unknown};
	core::combat::WeaponSnapshot::WeaponClass enemyWeaponClass{core::combat::WeaponSnapshot::WeaponClass::Unknown};
