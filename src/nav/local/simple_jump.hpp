...
enum class JumpProof : std::uint8_t
{
	Passed,
	TransientUnknown,
	StaticBlocked
...
struct JumpAttemptKey
{
	...
	{
		return a.agent == b.agent && a.actor == b.actor && a.map == b.map && a.source == b.source &&
			   a.target == b.target && a.traversal == b.traversal;
	}
};
...
struct JumpDecision
{
	...
	double fromTakeoff{}, along{}, lateral{}, minimumSpeed{}, maximumSpeed{}, speedLimit{}, desiredSpeed{},
		validatedDistance{};
	std::uint64_t validForUs{};
};
...
{
public:
	SimpleJump(Binding binding, JumpPlan plan, JumpLimits limits, JumpAttemptContext* attempt = nullptr) noexcept
	...
	JumpState state() const noexcept
	{
		return state_;
	}
