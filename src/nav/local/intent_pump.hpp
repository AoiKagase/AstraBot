...
{
public:
	static constexpr std::uint64_t decisionPeriodUs = 40000, maxIntentAgeUs = core::kMaximumMovementIntentUs;
	...
	void submissionRejected() noexcept
	{
		stop(PumpReason::SubmissionRejected);
	}
	std::uint64_t timeUs() const noexcept
	{
		return timeUs_;
	}
