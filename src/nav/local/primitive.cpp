...
{
	if (state_ != PrimitiveState::Idle)
		return {false, PrimitiveEvent::None, state_, PrimitiveReason::AlreadyEntered, {}};
...
{
	if (state_ != PrimitiveState::Running)
		return {false, PrimitiveEvent::None, state_, PrimitiveReason::None, {}};
