...
public:
	...
	std::optional<WalkDecision> update(const runtime::MovementSnapshot&, Binding, model::NavVector3 desiredTarget,
									   const query::NavSpatialIndex&, core::MapGeneration, GroundProbeLimits,
									   runtime::IWorldQueries&, std::uint64_t nowUs, std::uint32_t& used,
