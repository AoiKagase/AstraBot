...
public:
    static ProbeResult locate(const runtime::MovementSnapshot&, std::uint64_t,
        const query::NavSpatialIndex&, core::MapGeneration,
        runtime::IWorldQueries&, GroundProbeLimits) noexcept;
    static ProbeResult inspect(const runtime::MovementSnapshot&, std::uint64_t,
        model::NavAreaId, float x, float y, const query::NavSpatialIndex&,
