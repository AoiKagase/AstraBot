...
public:
	...
	PrimitiveState state() const noexcept
	{
		return state_;
	}
	const std::optional<corridor::Transition>& transition() const noexcept
	{
		return transition_;
	}
