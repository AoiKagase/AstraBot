...
struct LadderLimits
{
	double approachSpeed{80}, positionTolerance{1}, heightTolerance{4}, facingDegrees{5}, shaftTolerance{8},
		maximumHeight{4096}, maximumApproach{96}, maximumFallSpeed{260}, lowerExitHeight{8};
...
{
public:
	Ladder(Binding binding, LadderPlan plan, LadderLimits limits = {}) noexcept
		: binding_(binding), plan_(plan), limits_(limits)
	{
	}
	...
	LadderState state() const noexcept
	{
		return state_;
	}
