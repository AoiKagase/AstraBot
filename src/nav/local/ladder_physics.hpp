...
std::optional<model::NavVector3> ladderVelocity(const core::BotCommand&, model::NavVector3 outwardNormal,
												double maximumSpeed, bool floorSolid) noexcept;
...
std::optional<LadderAirStep> ladderAirStep(const core::BotCommand&, model::NavVector3 velocity,
										   LadderAirPhysics) noexcept;
...
std::optional<LadderAirStep> ladderJumpAirStep(const core::BotCommand&, model::NavVector3 outwardNormal,
											   LadderAirPhysics) noexcept;
} // namespace astrabot::nav::local
