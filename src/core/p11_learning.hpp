...
struct ContextualDangerKey final
{
	...
	combat::WeaponSnapshot::WeaponClass enemyWeaponClass{combat::WeaponSnapshot::WeaponClass::Unknown};
	std::uint32_t likelyEnemyArea{0};

	bool valid() const noexcept;
	friend bool operator<(const ContextualDangerKey& left, const ContextualDangerKey& right) noexcept;
};
...
public:
	...
	const std::vector<ContextualDangerRecord>& records() const noexcept
	{
		return records_;
	}
...
struct OpponentObservation final
{
	...
	TickId tick{};
	std::uint32_t area{0};
	combat::WeaponSnapshot::WeaponClass weapon{combat::WeaponSnapshot::WeaponClass::Unknown};
...
struct OpponentProfile final
{
	...
	combat::WeaponSnapshot::WeaponClass preferredWeapon{combat::WeaponSnapshot::WeaponClass::Unknown};
	double rotationSpeed{0.0};
