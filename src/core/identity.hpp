...
struct Generation
{
	...
	static constexpr Generation invalid() noexcept
	{
		return {};
	}
...
struct MapGeneration
{
	...
	static constexpr MapGeneration invalid() noexcept
	{
		return {};
	}
	constexpr bool isValid() const noexcept
...
struct PlayerId
{
	...
	static constexpr PlayerId invalid() noexcept
	{
		return {};
	}
	constexpr bool isValid() const noexcept
...
struct BotAgentId
{
	...
	static constexpr BotAgentId invalid() noexcept
	{
		return {};
	}
	constexpr bool isValid() const noexcept
...
struct TickId
{
	...
	static constexpr TickId invalid() noexcept
	{
		return {};
	}
	constexpr bool isValid() const noexcept
	...
	constexpr bool isBefore(TickId other) const noexcept
	{
		return value < other.value;
	}
	constexpr bool isAfter(TickId other) const noexcept
	{
		return value > other.value;
	}
