...
{
	astrabot::host::LifecycleEventKind kind{astrabot::host::LifecycleEventKind::None};
...
struct JoinTrace
{
	astrabot::adapter::cstrike::JoinPhase phase{astrabot::adapter::cstrike::JoinPhase::Idle};
	astrabot::adapter::cstrike::JoinError error{astrabot::adapter::cstrike::JoinError::None};
	astrabot::host::MapGeneration map{};
	astrabot::host::PlayerId player{};
	astrabot::adapter::cstrike::Team team{astrabot::adapter::cstrike::Team::Terrorist};
	...
	astrabot::core::perception::Team observedTeam{astrabot::core::perception::Team::Unknown};
...
struct CombatTrace
{
	...
	astrabot::core::perception::ObservationSource source{astrabot::core::perception::ObservationSource::Unknown};
	std::uint64_t targetAgeMicros{0};
	astrabot::core::combat::CombatAction action{astrabot::core::combat::CombatAction::NoOp};
	astrabot::core::combat::CombatReason reason{astrabot::core::combat::CombatReason::None};
...
void emitLifecycle(astrabot::host::LifecycleEventKind attemptedKind, const astrabot::host::LifecycleResult& result,
				   astrabot::host::MapGeneration currentMap, astrabot::host::PlayerId attemptedPlayer,
				   astrabot::host::TickId attemptedTick, LifecycleTraceSink sink) noexcept;
void emitFakeClient(const FakeClientTrace& trace, FakeClientTraceSink sink) noexcept;
void emitJoin(const JoinTrace& trace, JoinTraceSink sink) noexcept;
void emitRemoval(const RemovalTrace& trace, RemovalTraceSink sink) noexcept;
void emitMovement(const MovementTrace& trace, MovementTraceSink sink) noexcept;
