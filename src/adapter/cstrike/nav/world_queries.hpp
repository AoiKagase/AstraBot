...
nav::runtime::WorldQueryResult queryNavWorld(enginefuncs_t*, edict_t*, const nav::query::NavSpatialIndex*,
											 const nav::runtime::QueryRequest&, int maxEntities = 0,
											 const host::PlayerRegistry* players = nullptr,
											 NavPlayerResolver resolver = {}) noexcept;
...
std::optional<nav::model::NavVector3> doorUseView(enginefuncs_t*, edict_t*, std::uint64_t doorId,
