...
inline constexpr nav::local::WalkJumpLimits jumpLimits{
	{120, 100, 180, 16, 16, 5, 96, 1, 4, 21, 2000000, 200000, 1500000, 1500000}, {80, 1}, {21, 8, 0.125, 2, 18}};
...
JumpPhysicsAssessment assessStandardJumpPhysics(enginefuncs_t*, edict_t*, nav::local::Binding, core::TickId) noexcept;
JumpPhysicsReason validateJumpPhysicsTicket(const nav::local::JumpPhysics&, const nav::local::JumpPhysics&,
											nav::local::Binding, core::TickId) noexcept;
std::optional<nav::local::JumpPhysics> standardJumpPhysics(enginefuncs_t*, edict_t*, nav::local::Binding,
														   core::TickId) noexcept;
} // namespace astrabot::adapter::cstrike
