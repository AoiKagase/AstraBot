...
{
	core::economy::BuyFailureReason failure{core::economy::BuyFailureReason::None};
...
{
public:
	PurchaseExecutionResult execute(const core::economy::BuyPlan& plan, const PurchaseContext& context,
									IBuyOperations& operations) const noexcept;

private:
	static bool satisfied(const core::economy::EquipmentSnapshot& before, const core::economy::EquipmentSnapshot& after,
						  core::economy::PurchaseItem item) noexcept;
	static bool alreadyOwned(const core::economy::EquipmentSnapshot& inventory,
							 core::economy::PurchaseItem item) noexcept;
	static core::economy::BuyFailureReason mapFailure(DispatchStatus status) noexcept;
};
